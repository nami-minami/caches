...
"    let g:tex_items = ''
"endif
"if !exists("g:tex_parts")
"	let g:tex_parts = '\\chapter.*\|\\\(sub\)*section'
"endif
"
"if !exists("g:tex_noindent_env")
"    let g:tex_noindent_env = 'verbatim\|lstlisting'
"endif "}}}
"
"" VIM Setting " {{{
"setlocal autoindent
...
"    endif
"
"	" Indent for g:tex_parts which includes chapter and section in default
"	" --------------------------------------------------------------------
"	
"	if line =~ g:tex_parts
"		let ind = ind + shiftwidth()
